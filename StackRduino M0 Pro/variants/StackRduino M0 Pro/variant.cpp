...
const PinDescription g_APinDescription[]=
{
  ...
  // 14 - (User Switch)
  { PORTA, 28, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // GPIO D14 / User Button
  ...
  // 29..31 - SPI pins (ICSP:MISO,SCK,MOSI)
  // ----------------------
  ...
  // 32..33 - RX/TX LEDS (PB03/PA27)  -- unused
  // --------------------
  ...
  // 37..39 - Secondary SPI
  // ----------------------
  { PORTB,  3, PIO_SERCOM_ALT, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },  // SPI Flash MISO
  ...
  // 41 same as #8 - Internal NeoPixel (to match Metro M0)
  { PORTA,  6, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER|PIN_ATTR_ANALOG), ADC_Channel6, PWM1_CH0, TCC1_CH0, EXTERNAL_INT_6 }, // TCC1/WO[0]
